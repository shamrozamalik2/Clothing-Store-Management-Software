...
import { PlusIcon, TrashIcon, BeakerIcon, CubeIcon } from '@heroicons/react/24/outline';
...
export default function ManufacturingPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-xl font-semibold text-surface-100">Manufacturing & BOM</h1>
        <p className="text-sm text-surface-400 mt-0.5">Define bills of materials and record production batches.</p>
      </div>
